...
sendMessageBtn.addEventListener("click", sendChatMessage(lastMessage));
...
function sendChatMessage(lastMessage){
...
function displayChat(responseJson){
	...
	lastMessage = responseJson.content[0].text
}
