...
function Coffee (size, isDecaf, qtyCream, qtySugar) {
    ...
    this.description = function (){
        return `A ${this.size} sized ${this.decaf} coffee with ${this.qtyCream} of cream and ${this.qtySugar} sugar!`;
    }
}
/* STEP 2: Instatiate a coffee based on the above constructor function */
let aliceCoffee = new Coffee("Medium", false, 2, 1);
...
let meganCoffee = new robertCoffee.constructor("Extra Large", false, 20, 22);
